            ...
            <div>
              <label className="block text-sm font-bold text-slate-800 mb-2">
                ...
                <input
                  ...
                  className="block w-full px-4 py-3 border border-slate-300 rounded focus:ring-1 focus:ring-blue-500 focus:border-blue-500 transition-colors placeholder-slate-400 text-slate-700 text-base"
                />
            </div>
            ...
            <div>
              <label className="block text-sm font-bold text-slate-800 mb-2">
                ...
                <input
                  ...
                  className="block w-full px-4 py-3 border border-slate-300 rounded focus:ring-1 focus:ring-blue-500 focus:border-blue-500 transition-colors text-slate-700 text-base"
                />
            </div>

              ...
              <div>
                ...
                <div className="relative">
                  ...
                  <input
                    ...
                    required
                    className="pl-11 w-full px-4 py-3 bg-white border-2 border-slate-200 rounded-xl focus:ring-4 focus:ring-cyan-500/10 focus:border-cyan-500 transition-all font-medium"
           ...
           <div className="space-y-6">
             <div>
                ...
                <input
                  ...
                  required
                  className="w-full px-4 py-3 bg-white border-2 border-cyan-200/50 rounded-xl focus:ring-4 focus:ring-cyan-500/10 focus:border-cyan-500 transition-all font-medium"
                      ...
                      <div className="flex-1 animate-in fade-in slide-in-from-right-4 duration-300">
                        ...
                        <div className="relative">
                           ...
                           <input
                            ...
                            className="pl-10 w-full px-4 py-3 bg-cyan-50/50 border-2 border-cyan-200 rounded-xl focus:ring-4 focus:ring-cyan-500/20 focus:border-cyan-600 transition-all font-bold text-cyan-900 uppercase placeholder-cyan-300/60"
           ...
           <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
              <div className="bg-slate-50 p-4 sm:p-6 rounded-2xl border border-slate-100">
                ...
                <textarea
                  ...
                  className="w-full px-4 py-3 bg-white border-2 border-slate-200 rounded-xl focus:ring-4 focus:ring-cyan-500/10 focus:border-cyan-500 transition-all font-medium resize-none shadow-inner"
                  placeholder="Primary billing or registered office address..."
                />
              </div>
              ...
              <div className="bg-slate-50 p-4 sm:p-6 rounded-2xl border border-slate-100 flex flex-col">
                <div className="flex flex-wrap items-center justify-between gap-2 mb-2">
                  ...
                  >
                    {copyBillingToDelivery ? <CheckSquare className="w-3.5 h-3.5 mr-1" /> : <Square className="w-3.5 h-3.5 mr-1" />}
                    Same as Billing
                  </button>
                </div>
                <textarea
                  ...
                  className={`w-full px-4 py-3 border-2 rounded-xl focus:ring-4 transition-all font-medium resize-none flex-1 ${copyBillingToDelivery ? 'bg-slate-100 border-slate-200 text-slate-500 cursor-not-allowed hidden' : 'bg-white border-slate-200 focus:ring-cyan-500/10 focus:border-cyan-500 shadow-inner'}`}

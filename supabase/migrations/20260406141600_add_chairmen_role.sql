...
BEGIN
  ...
  -- Add the new constraint with chairmen role
  ALTER TABLE users ADD CONSTRAINT users_role_check 
    CHECK (role IN ('contractor', 'crusher_manager', 'manager', 'sales', 'director', 'worker', 'workers', 'quarry_worker', 'crusher_worker', 'chairmen'));
END $$;
